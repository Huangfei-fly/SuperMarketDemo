...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-10">
				<button type="button" class="btn btn-success" id="newSupply">
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel">供货</h4>
	      </div>
	      ...
	      <!-- 模态框中的表单，要实现同步，需要input的name属性和javabean中的属性一致 -->
			  ...
			  <div class="form-group">
			    <label for="inputPassword3" class="col-sm-2 control-label">连锁店</label>
			    <div class="col-sm-10">
			  ...
			  <div class="form-group">
			    <label for="inputPassword3" class="col-sm-2 control-label">供货数量</label>
			    <div class="col-sm-4">
			      <input type="number" class="form-control" name="supplyNum" id="supplyNum" placeholder="请输入供货数量">
			    </div>
			  </div>		  
			</form>
	      </div>
    ...
    <!-- 引入自定义的js文件 完成函数操作 -->
	<script><%@include file="/static/MYjs/Supply.js" %></script>
</body>
</html>